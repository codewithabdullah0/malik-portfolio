...
import profileimg2 from "../Images/Group 1000008403 (3).png";
                ...
                <div className="amazon-sec-div2">
                    <div className="container ">
                        ...
                        <div className="amazom-home-sec-text2">
                            <p>
                                Walmart Marketplace is one of the fastest-growing eCommerce platforms today. With more than 110 million monthly active users, now is the right time to set up your Walmart Marketplace storefront.
                                <br clssName="" />
                                The Walmart Marketplace platform has evolved into a powerful branding tool. Just like eBay and Amazon, it now offers various tools and features for both buyers and sellers.If you’re looking for an innovative way to sell your products and services, Walmart Marketplace gives you the leverage to generate more leads and boost your revenue.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="container-fluid amazon-home-sec-div3">
                <div className="container">
                    ...
                    <div className="row amazon-cards-div1">
                                ...
                                <div className="card-text-div1 mt-0">
                                    ...
                                    <div>
                                        <p className="concept-text2">
                                            Position your Walmart Marketplace business in front of your target audience and turn prospects into paying customers.
                                        </p>
                                    </div>
                                </div>
                            </Fade>
                        ...
                        <div className="col-md-4 col-12">
                            <Fade bottom duration={2000} delay={300}>
                                <div className="card-text-div1">
                                    ...
                                    <div>
                                        <h1 className="amazon-concept-text1">Sponsored Product Carousels</h1>
                                    </div>
                                    <div>
                                        <p className="concept-text2">
                                            Utilize sponsored product carousels to show your product ads on bottom of search pages.
                                        </p>
                                    </div>
                                </div>
                            </Fade>
                        ...
                        <div className="col-md-4 col-12 for-mobile-card-div-12">
                            <Fade bottom duration={2000} delay={500}>
                                <div className="black-card-text-div3 d-flex justify-content-center align-items-center mt-0">
