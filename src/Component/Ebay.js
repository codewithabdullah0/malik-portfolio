...
import "./Home.css";
import "./Amzon.css";
import profileimg2 from "../Images/Group 1000008403 (1).png";
          ...
          <h1 className="amazon-profile-text1" id="profile-text1">
            ...
            <Fade bottom cascade distance="60%">
                <img
                  src={profileimg2}
                  alt=""
                className=" d-inline amazon-profile-img2"
                />
            </Fade>{" "}
            <Fade bottom cascade distance="60%">
              Business
        ...
        <div className="amazon-sec-div2">
          <div className="container ">
            ...
            <div className="amazom-home-sec-text2">
              <p>
                              Embark on a journey through our eBay marketplace, where every click unveils a world of possibilities. Explore the vast array of products, each listing telling a story of quality and value. Join us in celebrating the diversity of sellers and buyers, as we bridge the gap between seekers and providers. eBay: where choice meets convenience, and your next extraordinary find awaits
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="col-md-4 col-12">
              <Fade bottom duration={2000} delay={300}>
                <div className="card-text-div1">
                  ...
                  <div>
                    <p className="concept-text2">
                                          We get you noticed. With our 'Listing' service, we simplify the process. We take care of the details to ensure your products or services stand out.
                    </p>
                  </div>
                </div>
              </Fade>
